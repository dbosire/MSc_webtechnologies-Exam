...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::resource('schools', 'MyClassController');
        Route::resource('sections', 'SectionController');
        Route::resource('departments', 'SectionController');
        Route::resource('subjects', 'SubjectController');
        Route::resource('programmes', 'SubjectController');
        Route::resource('grades', 'GradeController');
        Route::resource('exams', 'ExamController');
        Route::resource('dorms', 'DormController');
        Route::resource('payments', 'PaymentController');
        //Route::resource('studentapply', 'StudentApply');
        //Route::get('/studentapply', 'App\Http\Controllers\StudentApply@index');
